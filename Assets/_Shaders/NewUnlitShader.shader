...
Shader "Unlit/More Textures"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            v2f vert (float4 vertex : POSITION, float3 normal : NORMAL, float4 tangent : TANGENT, float2 uv : TEXCOORD0, float2 uv1 : TEXCOORD1)
            {
                v2f o;
                ...
                o.uv = uv;
                o.uv1 = uv1.xy * unity_LightmapST.xy + unity_LightmapST.zw;
                return o;
            }
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				lightMap = DecodeDirectionalLightmap(lightMap, lightMapDir, worldRefl);
